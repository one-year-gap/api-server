...
CREATE INDEX JOB_INST_EXEC_IX ON BATCH_JOB_EXECUTION (JOB_INSTANCE_ID);
CREATE INDEX JOB_EXEC_STEP_IX ON BATCH_STEP_EXECUTION (JOB_EXECUTION_ID);
CREATE INDEX JOB_EXEC_PARAMS_IX ON BATCH_JOB_EXECUTION_PARAMS (JOB_EXECUTION_ID);
