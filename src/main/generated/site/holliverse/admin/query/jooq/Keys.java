...
public class Keys {
    ...
    public static final UniqueKey<PersonaRecommendationRecord> PERSONA_RECOMMENDATION_PKEY = Internal.createUniqueKey(PersonaRecommendation.PERSONA_RECOMMENDATION, DSL.name("persona_recommendation_pkey"), new TableField[] { PersonaRecommendation.PERSONA_RECOMMENDATION.MEMBER_ID }, true);
    ...
    public static final UniqueKey<ProductViewHistoryRecord> PK_MEMBER_PRODUCT = Internal.createUniqueKey(ProductViewHistory.PRODUCT_VIEW_HISTORY, DSL.name("pk_member_product"), new TableField[] { ProductViewHistory.PRODUCT_VIEW_HISTORY.MEMBER_ID, ProductViewHistory.PRODUCT_VIEW_HISTORY.PRODUCT_ID }, true);
    ...
    public static final ForeignKey<MemberRecord, FamilyGroupRecord> MEMBER__FK_MEMBER_TO_FAMILY_GROUP = Internal.createForeignKey(Member.MEMBER, DSL.name("fk_member_to_family_group"), new TableField[] { Member.MEMBER.FAMILY_GROUP_ID }, Keys.PK_FAMILY_GROUP, new TableField[] { FamilyGroup.FAMILY_GROUP.FAMILY_GROUP_ID }, true);
    ...
    public static final ForeignKey<PersonaRecommendationRecord, MemberRecord> PERSONA_RECOMMENDATION__FK_PERSONA_RECOMMENDATION_MEMBER = Internal.createForeignKey(PersonaRecommendation.PERSONA_RECOMMENDATION, DSL.name("fk_persona_recommendation_member"), new TableField[] { PersonaRecommendation.PERSONA_RECOMMENDATION.MEMBER_ID }, Keys.PK_MEMBER, new TableField[] { Member.MEMBER.MEMBER_ID }, true);
