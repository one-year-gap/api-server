...
public class Address extends TableImpl<AddressRecord> {
     ...
     */
    public final TableField<AddressRecord, String> PROVINCE = createField(DSL.name("province"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.address.city</code>.
     */
    public final TableField<AddressRecord, String> CITY = createField(DSL.name("city"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.address.street_address</code>.
     */
    public final TableField<AddressRecord, String> STREET_ADDRESS = createField(DSL.name("street_address"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.address.postal_code</code>.
     */
    public final TableField<AddressRecord, String> POSTAL_CODE = createField(DSL.name("postal_code"), SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>public.address.created_at</code>.
     */
    public final TableField<AddressRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.address.updated_at</code>.
     */
    public final TableField<AddressRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<UniqueKey<AddressRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UK_ADDRESS_UNIQUE);
    }
    ...
    public MemberPath member() {
        if (_member == null)
            _member = new MemberPath(this, null, Keys.MEMBER__FK_MEMBER_TO_ADDRESS.getInverseKey());
