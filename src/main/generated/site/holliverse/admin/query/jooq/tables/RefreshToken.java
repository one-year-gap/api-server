...
public class RefreshToken extends TableImpl<RefreshTokenRecord> {
    ...
    /**
     * The column <code>public.refresh_token.refresh_token_id</code>.
     */
    public final TableField<RefreshTokenRecord, Long> REFRESH_TOKEN_ID = createField(DSL.name("refresh_token_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.refresh_token.member_id</code>.
     */
    public final TableField<RefreshTokenRecord, Long> MEMBER_ID = createField(DSL.name("member_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.refresh_token.token_hash</code>.
     */
    public final TableField<RefreshTokenRecord, String> TOKEN_HASH = createField(DSL.name("token_hash"), SQLDataType.VARCHAR(128).nullable(false), this, "");
    ...
    /**
     * The column <code>public.refresh_token.updated_at</code>.
     */
    public final TableField<RefreshTokenRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_REFRESH_TOKEN_EXPIRES_AT, Indexes.IDX_REFRESH_TOKEN_MEMBER_ID);
    }
    ...
    public List<UniqueKey<RefreshTokenRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UK_REFRESH_TOKEN_HASH);
    }

    @Override
    public List<ForeignKey<RefreshTokenRecord, ?>> getReferences() {
        return Arrays.asList(Keys.REFRESH_TOKEN__FK_REFRESH_TOKEN_MEMBER);
    }
    ...
    public MemberPath member() {
        if (_member == null)
            _member = new MemberPath(this, Keys.REFRESH_TOKEN__FK_REFRESH_TOKEN_MEMBER, null);
